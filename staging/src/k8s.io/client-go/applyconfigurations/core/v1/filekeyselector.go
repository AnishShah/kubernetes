...
// FileKeySelectorApplyConfiguration represents an declarative configuration of the FileKeySelector type for use
// with apply.
...
// FileKeySelectorApplyConfiguration constructs an declarative configuration of the FileKeySelector type for use with
// apply.

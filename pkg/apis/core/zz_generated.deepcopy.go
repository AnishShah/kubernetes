...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FileEnvSource) DeepCopyInto(out *FileEnvSource) {
	*out = *in
	if in.Optional != nil {
		in, out := &in.Optional, &out.Optional
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FileEnvSource.
func (in *FileEnvSource) DeepCopy() *FileEnvSource {
	if in == nil {
		return nil
	}
	out := new(FileEnvSource)

...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.FileEnvSource)(nil), (*core.FileEnvSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_FileEnvSource_To_core_FileEnvSource(a.(*v1.FileEnvSource), b.(*core.FileEnvSource), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.FileEnvSource)(nil), (*v1.FileEnvSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_FileEnvSource_To_v1_FileEnvSource(a.(*core.FileEnvSource), b.(*v1.FileEnvSource), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1.FileKeySelector)(nil), (*core.FileKeySelector)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_FileKeySelector_To_core_FileKeySelector(a.(*v1.FileKeySelector), b.(*core.FileKeySelector), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.FileKeySelector)(nil), (*v1.FileKeySelector)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_FileKeySelector_To_v1_FileKeySelector(a.(*core.FileKeySelector), b.(*v1.FileKeySelector), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_EnvFromSource_To_core_EnvFromSource(in *v1.EnvFromSource, out *core.EnvFromSource, s conversion.Scope) error {
	...
	out.FileRef = (*core.FileEnvSource)(unsafe.Pointer(in.FileRef))
	return nil
}
...
func autoConvert_core_EnvFromSource_To_v1_EnvFromSource(in *core.EnvFromSource, out *v1.EnvFromSource, s conversion.Scope) error {
	...
	out.FileRef = (*v1.FileEnvSource)(unsafe.Pointer(in.FileRef))
	return nil
}
...
func autoConvert_core_EnvVarSource_To_v1_EnvVarSource(in *core.EnvVarSource, out *v1.EnvVarSource, s conversion.Scope) error {
	...
	out.FileKeyRef = (*v1.FileKeySelector)(unsafe.Pointer(in.FileKeyRef))
	return nil
}
...
func autoConvert_v1_FileEnvSource_To_core_FileEnvSource(in *v1.FileEnvSource, out *core.FileEnvSource, s conversion.Scope) error {
	out.Path = in.Path
	out.Optional = (*bool)(unsafe.Pointer(in.Optional))
	return nil
}

// Convert_v1_FileEnvSource_To_core_FileEnvSource is an autogenerated conversion function.
func Convert_v1_FileEnvSource_To_core_FileEnvSource(in *v1.FileEnvSource, out *core.FileEnvSource, s conversion.Scope) error {
	return autoConvert_v1_FileEnvSource_To_core_FileEnvSource(in, out, s)
}

func autoConvert_core_FileEnvSource_To_v1_FileEnvSource(in *core.FileEnvSource, out *v1.FileEnvSource, s conversion.Scope) error {
	out.Path = in.Path
	out.Optional = (*bool)(unsafe.Pointer(in.Optional))
	return nil
}

// Convert_core_FileEnvSource_To_v1_FileEnvSource is an autogenerated conversion function.
func Convert_core_FileEnvSource_To_v1_FileEnvSource(in *core.FileEnvSource, out *v1.FileEnvSource, s conversion.Scope) error {
	return autoConvert_core_FileEnvSource_To_v1_FileEnvSource(in, out, s)
}

func autoConvert_v1_FileKeySelector_To_core_FileKeySelector(in *v1.FileKeySelector, out *core.FileKeySelector, s conversion.Scope) error {
	out.Path = in.Path
	out.Key = in.Key
	out.Optional = (*bool)(unsafe.Pointer(in.Optional))
	return nil
...
func Convert_v1_FileKeySelector_To_core_FileKeySelector(in *v1.FileKeySelector, out *core.FileKeySelector, s conversion.Scope) error {
	return autoConvert_v1_FileKeySelector_To_core_FileKeySelector(in, out, s)
}

func autoConvert_core_FileKeySelector_To_v1_FileKeySelector(in *core.FileKeySelector, out *v1.FileKeySelector, s conversion.Scope) error {
	out.Path = in.Path
	out.Key = in.Key
	out.Optional = (*bool)(unsafe.Pointer(in.Optional))
	return nil
...
func Convert_core_FileKeySelector_To_v1_FileKeySelector(in *core.FileKeySelector, out *v1.FileKeySelector, s conversion.Scope) error {
